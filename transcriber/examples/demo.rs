...
//! Demo showing how to use the Transcriber service and client
//! 
...
async fn main() -> Result<()> {
    ...
    info!("Transcriber Demo Starting");
    ...
    info!("In a real scenario, the transcriber service would process these chunks...");
