#!/bin/bash
# Install Transcriber as a macOS service
...
CURRENT_DIR=$(pwd)
sed "s|/Users/arach/dev/scout/transcriber|$CURRENT_DIR|g" "$PLIST_FILE" > "$INSTALL_PATH"
