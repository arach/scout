...
// Note: Generated docs are loaded dynamically if available
...
function OverviewSection() {
  return (
    <div className="space-y-6" style={{ color: '#2A2520' }}>
      <div>
        <h1 className="font-serif text-4xl font-semibold mb-4" style={{ color: '#2A2520' }}>Scout SDK Documentation</h1>
        <p className="font-sans text-lg font-light mb-8" style={{ color: '#6B5D4F' }}>
          Integrate local-first voice transcription into your applications
        </p>
      </div>

      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl" style={{ backgroundColor: '#FDFBF7', border: '1px solid #D4C4B0' }}>
          <div className="p-4">
            <h3 className="flex items-center gap-2 font-serif font-semibold text-lg mb-2" style={{ color: '#2A2520' }}>
              <Zap className="w-5 h-5" style={{ color: '#C2996C' }} />
              Quick Start
            </h3>
          </div>
          <div className="px-4 pb-4">
            <p className="font-sans text-sm mb-4" style={{ color: '#6B5D4F' }}>
        ...
        <div className="rounded-xl" style={{ backgroundColor: '#FDFBF7', border: '1px solid #D4C4B0' }}>
          <div className="p-4">
            <h3 className="flex items-center gap-2 font-serif font-semibold text-lg mb-2" style={{ color: '#2A2520' }}>
              <Code className="w-5 h-5" style={{ color: '#C2996C' }} />
              API Reference
            </h3>
          </div>
          <div className="px-4 pb-4">
        ...
        <div className="rounded-xl" style={{ backgroundColor: '#FDFBF7', border: '1px solid #D4C4B0' }}>
          <div className="p-4">
            <h3 className="flex items-center gap-2 font-serif font-semibold text-lg mb-2" style={{ color: '#2A2520' }}>
              <Globe className="w-5 h-5" style={{ color: '#C2996C' }} />
              Examples
            </h3>
          </div>
          <div className="px-4 pb-4">
      ...
      <div className="rounded-lg p-6 mt-8" style={{ backgroundColor: '#F5F0E6', border: '1px solid #D4C4B0' }}>
        <div className="flex items-start gap-4">
          <AlertCircle className="w-6 h-6 flex-shrink-0 mt-1" style={{ color: '#C2996C' }} />
          <div>
            <h3 className="font-serif font-semibold mb-2" style={{ color: '#2A2520' }}>First Time Using Scout?</h3>
            <p className="font-sans text-sm mb-4" style={{ color: '#6B5D4F' }}>
...
function GeneratedDocSection({ docId }: { docId: string }) {
  ...
  if (!doc) {
    return (
      <div className="space-y-6">
        <div className="rounded-lg p-6" style={{ backgroundColor: '#FFF9E6', border: '1px solid #E8DDD0' }}>
          <div className="flex items-start gap-4">
            <AlertCircle className="w-6 h-6 flex-shrink-0 mt-1" style={{ color: '#D4A574' }} />
            <div>
              <h3 className="font-serif font-semibold mb-2" style={{ color: '#2A2520' }}>Documentation Not Built</h3>
              <p className="font-sans text-sm" style={{ color: '#6B5D4F' }}>
                This documentation hasn't been generated yet. Run <code className="px-2 py-1 rounded font-mono text-xs" style={{ backgroundColor: '#F5F0E6', color: '#8B6957', border: '1px solid #E8DDD0' }}>pnpm build:docs</code> to generate it from the markdown files.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif text-4xl font-semibold mb-4" style={{ color: '#2A2520' }}>{(doc as any).title}</h1>
      </div>
...
function QuickStartSection() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif text-4xl font-semibold mb-4" style={{ color: '#2A2520' }}>Quick Start</h1>
        <p className="font-sans text-lg font-light mb-8" style={{ color: '#6B5D4F' }}>
          Get up and running with Scout's push-to-talk recording
        </p>
      </div>

      <div className="rounded-lg p-6" style={{ backgroundColor: '#F5F0E6', border: '1px solid #D4C4B0' }}>
        <div className="flex items-start gap-4">
          <Mic className="w-6 h-6 flex-shrink-0 mt-1" style={{ color: '#C2996C' }} />
          <div>
            <h3 className="font-serif font-semibold mb-2" style={{ color: '#2A2520' }}>Push-to-Talk Recording</h3>
            <p className="font-sans text-sm mb-4" style={{ color: '#6B5D4F' }}>
              Scout uses a simple global hotkey system for instant voice recording from anywhere on your Mac.
            </p>
            <div className="rounded-lg p-4 font-mono text-sm" style={{ backgroundColor: '#FDFBF7', border: '1px solid #E8DDD0' }}>
              <div className="mb-2" style={{ color: '#2A2520' }}><strong>Default Hotkey:</strong> ⌘⇧Space (Cmd+Shift+Space)</div>
              <div style={{ color: '#8B6957' }}>Press and hold to record, release to stop</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <section>
        <h2 className="font-serif text-2xl font-semibold mb-4" style={{ color: '#2A2520' }}>Basic Usage</h2>
        <div className="space-y-4">
          <div className="rounded-lg p-4" style={{ backgroundColor: '#FDFBF7', border: '1px solid #D4C4B0' }}>
            <h3 className="font-serif font-semibold mb-2" style={{ color: '#2A2520' }}>1. Launch Scout</h3>
            <p className="font-sans text-sm" style={{ color: '#6B5D4F' }}>Open Scout from your Applications folder or use Spotlight search.</p>
          </div>
...
export default function DocsPageContent() {
  ...
  const SectionComponent: React.ComponentType = isGeneratedDoc
            ...
            <aside className="w-64 flex-shrink-0 hidden lg:block">
              <div className="sticky top-20 space-y-6">
                {navSections.map((section, idx) => (
                  <div key={idx}>
                    <h3 className="font-sans text-xs uppercase tracking-wider mb-2 font-semibold" style={{ color: '#A68B5B' }}>
                      {section.title}
                    </h3>
                          ...
                          <button
                            ...
                            onMouseEnter={(e) => {
                              if (selectedSection !== item.id) {
                                e.currentTarget.style.backgroundColor = 'rgba(194, 154, 108, 0.05)';
                              }
                            }}
                            onMouseLeave={(e) => {
                              if (selectedSection !== item.id) {
